...
describe("Testing $is operator", () => {
    describe("Testing is name option", () => {
        let schema = new __1.Validall({ name: { $is: "name" } });
    ...
    describe("Testing is notEmpty option", () => {
        let schema = new __1.Validall({ items: { $is: "notEmpty" } });
        it("should return true", () => {
    ...
    describe("Testing is number option", () => {
        let schema = new __1.Validall({ mobile: { $is: "number" } });
        it("should return true", () => {
    ...
    describe("Testing is date option", () => {
        let schema = new __1.Validall({ birthdate: { $is: "date" } });
        it("should return true", () => {
    ...
    describe("Testing is email option", () => {
        let schema = new __1.Validall({ email: { $is: "email" } });
        it("should return true", () => {
    ...
    describe("Testing is url option", () => {
        let schema = new __1.Validall({ website: { $is: "url" } });
        it("should return true", () => {
