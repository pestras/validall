...
describe("Testing $type operator", () => {
  ...
  describe("Testing string type", () => {
    let schema = new Validall({ name: { $type: "string" } });
  ...
  describe("Testing number type", () => {
    let schema = new Validall({ age: { $type: "number" } });
  ...
  describe("Testing boolean type", () => {
    let schema = new Validall({ passed: { $type: "boolean" } });
  ...
  describe("Testing int type", () => {
    let schema = new Validall({ count: { $type: "int" } });
  ...
  describe("Testing float type", () => {
    let schema = new Validall({ count: { $type: "float" } });
  ...
  describe("Testing date type", () => {
    let schema = new Validall({ birthdate: { $type: "date" } });
  ...
  describe("Testing function type", () => {
    let schema = new Validall({ handler: { $type: "function" } });
  ...
  describe("Testing object type", () => {
    let schema = new Validall({ contacts: { $type: "object" } });
  ...
  describe("Testing array type", () => {
    let schema = new Validall({ items: { $type: "array" } });
  ...
  describe("Testing primitive type", () => {
    let schema = new Validall({ prop: { $type: "primitive" } });
  ...
  describe("Testing regexp type", () => {
    let schema = new Validall({ reg: { $type: "regexp" } });
